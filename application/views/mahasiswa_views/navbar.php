...
<div class="sidenav" id="mySidenav">
  ...
  <div class="account-container">
    ...
    <?php 
    echo "
    <div  class='account-detail'><a>".$mahasiswa_yang_login[0]->nama."</a></div>
    <div  class='account-detail'><a>".$mahasiswa_yang_login[0]->nim."</a></div>
    ";
    ?>
  </div>
  <br />
  <a href="<?= site_url('mahasiswa/KRS/tambah') ?>">Tambah KRS</a>
  <hr />
  <br />
  <br />
  <br />
